    ...
    <main id="main" className="gallery-main gallery-detail">
      <div className="intro gallery-detail-intro">
        ...
        <div className="gallery-detail-kicker">
          <span className="eyebrow">
            {entry.group === "examples" ? "Example" : "Edge case"} / {entry.recipe} / {entry.preset}
          </span>
        ...
        {result.ok ? (
          <>
            <section
              ...
              tabIndex={0}
            >
              <div className="gallery-full-svg" dangerouslySetInnerHTML={{ __html: result.svg }} />
            </section>
      ...
      <section className="gallery-detail-info" aria-labelledby="outcome-heading">
        <div>
          ...
          <p>
            These checks compare the renderer outcome with the declared case expectation. The stress
            test also checks determinism, geometry, and connectivity.
          </p>
        </div>
